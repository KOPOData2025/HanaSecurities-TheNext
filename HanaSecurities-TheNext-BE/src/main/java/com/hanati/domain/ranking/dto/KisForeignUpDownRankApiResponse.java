...
@NoArgsConstructor
@AllArgsConstructor
public class KisForeignUpDownRankApiResponse {
    ...
    private List<UpDownRankData> output2;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class UpDownRankData {
        @JsonProperty("rsym")
        ...
        @JsonProperty("n_base")
        private String nBase;  // 기준가격

        @JsonProperty("n_diff")
        private String nDiff;  // 기준가격대비

        @JsonProperty("n_rate")
        private String nRate;  // 기준가격대비율
